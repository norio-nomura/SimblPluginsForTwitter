//
//  TwippleImageService.m
//  SimblPluginsForTwitter
//

#import "ImageServiceManager.h"
#import "TwippleImageService.h"

@implementation TwippleImageService
...
- (BOOL)canHandleURL:(NSURL *)url;
{
    ...
    return NSOrderedSame == [url.host compare:@"p.twipple.jp" options:NSCaseInsensitiveSearch] && ([components count] == 2 ||
...
- (NSDictionary *)mediaInfoFromUrlInfo:(NSDictionary *)urlInfo;
{
    ...
    urlComponents.path = [@"/show/large/" stringByAppendingPathComponent:imageID];
    urlComponents.query = @"";
...
- (void)parseDict:(NSDictionary*)dict forTwitterEntityMedia:(id<SimblPluginsForTwitter_TwitterEntityMedia>)media;
{
    ...
    urlComponents.path = [@"/show/large/" stringByAppendingPathComponent:media.mediaID];
    urlComponents.query = @"";
...
/*!
 *  See: http://p.twipple.jp/wiki/API_Thumbnail
 */
