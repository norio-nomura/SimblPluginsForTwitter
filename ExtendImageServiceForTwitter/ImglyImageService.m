...
#import "ImglyImageService.h"

@implementation ImglyImageService
...
- (BOOL)canHandleURL:(NSURL *)url;
{
    ...
    return NSOrderedSame == [url.host compare:@"img.ly" options:NSCaseInsensitiveSearch] && ([components count] == 2 ||
